import "./ClassYearList.css";

const ClassYearList= ({setCohort})=>{
    
     return(
        <section className="ClassYearList">

             <h4>Choose Class by Start Date</h4>

            <ul className='ClassListYear__classes'>
