   ...
   function Student ({student}) {
    ...
    <div className='student' key={student.id}>
        ...
        <div className="student__extra" ><span className="show" onClick={handleDropDown}>Show {show}</span></div>
        {/* <StudentMenu visible={visible} student={student} notes={notes} setNote={setNote}/> */}
    </div>
    )
